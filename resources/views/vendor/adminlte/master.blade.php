...
<head>
    ...
    @yield('adminlte_css')
    <style>
        /* Agar nama sekolah yang panjang di sidebar Admin bisa turun ke bawah (wrap) */
    ...
    {{-- Favicon --}}
    @php
        $profileFavicon = \Illuminate\Support\Facades\Schema::hasTable('school_profiles') ? \App\Models\SchoolProfile::first() : null;
    @endphp
    @if($profileFavicon && $profileFavicon->school_logo)
        <link rel="icon" href="{{ asset('storage/' . $profileFavicon->school_logo) }}">
